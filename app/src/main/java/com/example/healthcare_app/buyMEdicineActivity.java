...
public class buyMEdicineActivity extends AppCompatActivity {
    ...
    private String [][] packages=
            {
                    ...
                    {"healthVit Chromimum Picolinate 200mcg Capsule", "", "", "","305"},
                    {"Vitamin B Complex Capsules", "", "", "","448"},
                    {"Inlife Vitamin E Wheat Germ Oil Capsule", "", "", "","539"},
                    {"Dolo 650 Tablet", "", "", "","30"},
                    {"Crocin 650 Tablet", "", "", "","50"},
                    {"Strepsils Medicated Lozenges for Score Throt", "", "", "","40"},
    ...
    private String [] package_details=
            {
              ...
              "Reduce the risk of calcium deficiency, Rickets, and Osteoporosis\n"+
                     "Promotes mobility adn flexibility of joints",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst=findViewById(R.id.listviewbymedicine);
        btnback=findViewById(R.id.buttonbuymedicineback);
        btngotocard=findViewById(R.id.buttonbuymedicineGotocard);
