...
public class healthArticleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback=findViewById(R.id.buttonhealthdetails);
        lst=findViewById(R.id.healtharticlelistview);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it=new Intent(healthArticleActivity.this,Book_healthArticlesDetailsActivity.class);
